            ...
            <div class="modal-body">
                <form action="./endpoint/add-question.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="correctAnswer" name="correct_answer" maxlength="1" required>
                    </div>
            ...
            <div class="modal-body">
                <form action="./endpoint/update-question.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="updateQuestion" name="quiz_question" required>
                    </div>
                    <div class="form-group">
                        <label for="updateOptionA">Option A</label>
                        <input type="text" class="form-control" id="updateOptionA" name="option_a" required>
                    </div>
                    <div class="form-group">
                        <label for="updateOptionB">Option B</label>
                        <input type="text" class="form-control" id="updateOptionB" name="option_b" required>
                    </div>
                    <div class="form-group">
                        <label for="updateOptionC">Option C</label>
                        <input type="text" class="form-control" id="updateOptionC" name="option_c" required>
                    </div>
                    <div class="form-group">
                        <label for="updateOptionD">Option D</label>
                        <input type="text" class="form-control" id="updateOptionD" name="option_d" required>
                    </div>
                    <div class="form-group">
                        <label for="updateCorrectAnswer">Correct Answer (Letter Only)</label>
                        <input type="text" class="form-control" id="updateCorrectAnswer" name="correct_answer" maxlength="1" required>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                        <button type="submit" class="btn btn-dark">Save changes</button>
...
<!-- Result Modal -->
<div class="modal fade mt-5" id="resultModal" tabindex="-1" aria-labelledby="result" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form action="./endpoint/add-result.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="yearSection" name="year_section" required>
                    </div>
                    <div class="form-group">
